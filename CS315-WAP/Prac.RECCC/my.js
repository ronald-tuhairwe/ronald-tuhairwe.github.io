...
//         leaves=leaves.concat(allLeaf(key))
//     }
//     leaves.push(key)
// }
// return leaves;
...
// console.log(allLeaf(simpleObject));
let company = {
  sales: [
...
//obj={ John: 1000, Alice: 600, Peter: 2000, Alex: 1800, Jack: 1300 }
...
// console.log("herrrre iamm*************",getEmployeeNameSalary(company));
